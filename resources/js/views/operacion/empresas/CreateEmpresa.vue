                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="nombre_comercial_corto" v-model="empresa.nombre_comercial_corto" class="form-control" id="nombre_comercial_corto" >
    ...
    beforeCreate() {
        this.$nextTick( async function () {
            await this.axios.get('paises/all').then(response => {
                ...
                this.empresa.id_pais = this.paises[0].id_pais;
